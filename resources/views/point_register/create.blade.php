...
@section('content')
        ...
        <form action="{{ route('posts.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 login-form">
                <div class="col-md-4">
                    ...
                    <div class="mt-2">
                        <input style="align-content: center" type="text" name="title" id="title"
                            autocomplete="given-title"
                            class="block w-full rounded-md border-gray-300 focus:outline-none focus:ring focus:border-indigo-300 sm:text-sm">
                        @error('title')
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        <button type="submit"
            class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cadastrar</button>
    </div>
    </form>
